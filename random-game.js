...
function getRandomGame() {
  // Get Algolia client from the instantsearch instance
  // This assumes you're using the global instantsearch variable
  const searchClient = window.search.helper.client;
  const indexName = window.search.helper.getIndex();
