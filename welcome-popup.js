...
function initWelcomePopup() {
  ...
  function updateComplexityValue(value) {
    complexityValueElement.textContent = complexityLabels[value];
  }
  ...
  function applyPreferencesWithMapping() {
    ...
    // Get the complexity from the slider's value, mapped through complexityLabels
    const sliderValue = complexitySlider.value;
    const complexityValue = complexityLabels[sliderValue];
